客户端使用手册
==================
.. note:: 功夫交易系统的操作界面借助模块化自由集成解决方案获得灵活性和可视性，力求更加便捷直观
  
  系统以功能为组，并分别适配不同面板，用户可根据操作习惯灵活地使用和调整面板，并按需增设功能按钮；

  模块化系统具有更加灵活的统计能力，如持仓面板可根据点选内容的不同，对策略、账户、交易算法的持仓进行分别统计。针对不常用的功能，用户可进行隐藏，简化页面信息。
...
.. include:: ../../shared/v3/003-strategy.rst
